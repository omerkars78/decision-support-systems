...
<style>
    ...
    .first_box_makina table {
        width: 100%;
        border-collapse: collapse;
    }

    .first_box_makina thead {
        background: #efefef;
        text-align: left;
    }
            ...
            <div class="third_box_side">
                <div class="third_box">
                    <div class="ariza_turu_title">
                        <p class="ariza_sayisi" style="margin-right: 140px; margin-top:10px; margin-bottom:30px;">
                            Makinaların 6 Aylık Arıza Sayısı</p>
                    </div>
                    <div class="box-2">
